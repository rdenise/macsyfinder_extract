...
def write_merge_file(generique_report_file, all_report_file, write_file) :
	...
	:type: str
	:param generique_report_file: name of the macsyfinder report for T2SS.xml, T4P.xml, Tad.xml, Archaellum.xml
	:type: str
...
fileGenerique = os.path.abspath(sys.argv[1])
fileAll = os.path.abspath(sys.argv[2])

fileWrite = "/Users/rdenise/Documents/Analysis_macsyfinder/27_04_16/merge_macsyfinder.report"
